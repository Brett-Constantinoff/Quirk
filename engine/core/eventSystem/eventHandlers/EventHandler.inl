...
namespace Quirk::Engine::Core::EventSystem::EventHandlers
{
    ...
    inline EventHandler<T, EventType>::EventHandler(T& instance, void (T::* memberFunction)(const EventType&))
        :   instance{ instance }, 
    ...
    template<class T, class EventType>
    inline void EventHandler<T, EventType>::call(const Event& event)
    {
